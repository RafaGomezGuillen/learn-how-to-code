  ...
  return (
    <>
      <div className="footer">
        <p>
          This page was created for learning the first quarter of the
          Development of web applications. All examples of code was made by me,
          and it could be improved and possibly wrong. Tutorials and exercises
          are reviewed to avoid errors, but I can not guarantee full correctness
          of all content.
        </p>
        <p>2023-2023</p>
